...
public class InterActualizarStock extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //validamos la seleccion de los productos
        if (!jComboBox_producto.getSelectedItem().equals("Seleccione producto:")) {
            ...
            if (!txt_cantidad_nueva.getText().isEmpty()) {
                ...
                if (validacion == true) {
                    ...
                    JOptionPane.showMessageDialog(null, "En la cantidad no se permite caracteres no numericos");
                }

            } else {
                JOptionPane.showMessageDialog(null, "Ingrese una cantidad para sumar el stock del producto");
            }
