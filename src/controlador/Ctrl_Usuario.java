...
public class Ctrl_Usuario {
    ...
    public boolean guardar(Usuario objeto){
        ...
        try {
            ...
            PreparedStatement consulta = cn.prepareStatement("insert into tb_usuario values(?,?,?,?,?,?,?)");//? son los numeros de atributos que cubre
    ...
    public boolean eliminar(int idUsuario){
        ...
        try {
            ...
            PreparedStatement consulta = cn.prepareStatement(
                    "delete from tb_usuario where idUsuario ='" +idUsuario + "'");//Eliminar la categoria que seleccione
