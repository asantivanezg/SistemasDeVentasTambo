...
ADD FOREIGN KEY (idCabeceraVenta) REFERENCES TB_CABECERA_VENTAS(idCabeceraVenta);

ALTER TABLE TB_CABECERA_VENTAS
ADD FOREIGN KEY (idCliente) REFERENCES TB_CLIENTE(idCliente);

ALTER TABLE TB_PRODUCTO
ADD FOREIGN KEY (idCategoria) REFERENCES TB_CATEGORIA(idCategoria);

ALTER TABLE TB_DETALLE_VENTAS
ADD FOREIGN KEY (idProducto) REFERENCES TB_PRODUCTO(idProducto);
